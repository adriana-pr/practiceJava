...
// ------------------------------------------------------------------
public class MySecondBot extends Bot {

    int dist = 50; // Distance to move when we're hit, forward or back

    // The main method starts our bot
    public static void main(String[] args) {
        new MySecondBot().start();
    }

    // Constructor, which loads the bot settings file
    MySecondBot() {
        super(BotInfo.fromFile("MySecondBot.json"));
    }
    ...
    public void run() {
        // Set colors
        setBodyColor(Color.fromString("#642e91")); 
        setTurretColor(Color.fromString("#e8e187")); 
        setRadarColor(Color.fromString("#e8e187")); 
        setBulletColor(Color.fromString("#a30cf0"));
        setScanColor(Color.fromString("#9271ad"));
